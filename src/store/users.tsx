...
export const usersReducer = (state: any = null, action: any) => {
  switch (action.type) {
    case 'SET_USERS':
      return {
        users: [...action.data],
...
const getUsersAsyncAction = (searchQuery: string | null) => async (
  dispatch: Dispatch,
  getState: any
) => {
...
const getUserAsyncAction = (searchQuery: string | null) => async (
  dispatch: Dispatch,
  getState: any
) => {
  if (searchQuery !== null && searchQuery !== '') {
